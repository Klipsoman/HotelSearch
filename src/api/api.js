...
export function fetchHotels(location = 'moscow', checkIn = getDates().checkIn, checkOut = getDates().checkOut ){
    ...
    return fetch(`https://engine.hotellook.com/api/v2/cache.json?token=d90bb770ade731a175bb6383cd79e6cd&currency=rub&location=${location}&checkIn=${checkIn}&checkOut=${checkOut}&lang=ru&limit=8`)
    .then(res=>res.json())
}